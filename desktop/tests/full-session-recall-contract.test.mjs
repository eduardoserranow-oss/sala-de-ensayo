...
for(const token of ["const BRIDGE_VERSION = '12.0.0'","'full-session-recall'","'project-version-history'","'background-audio'","'stable-desktop-release'",'desktop-workspace12','vibe-roulette-full-session-recall-v1.js?v=project-versions12'])assert.ok(preload.includes(token),`Phase 12 preload missing ${token}`);
