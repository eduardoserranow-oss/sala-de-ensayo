...
console.log('PASS FORTISSIMO Desktop Phase 2 session contract: remembered login persists in an isolated Electron profile and reuses the existing FORTISSIMO cloud account flow.');
