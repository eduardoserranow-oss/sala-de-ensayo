...
console.log('PASS FORTISSIMO Desktop session contract remains intact through Phase 5: remembered login persists in an isolated Electron profile and reuses the existing FORTISSIMO cloud account flow.');
