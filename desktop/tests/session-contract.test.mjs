...
for (const token of ['fortissimo_login','fortissimo_logout','fortissimo_load_state','cloudToken']) {
...
console.log('PASS FORTISSIMO Desktop persistent account/session contract remains intact through Phase 12.');
