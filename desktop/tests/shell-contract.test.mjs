...
]) assert.ok(main.includes(token), `Desktop Phase 9.1 shell contract missing: ${token}`);
...
console.log('PASS FORTISSIMO Desktop Phase 9.1 shell contract: secure live-web shell, background audio, project/session intelligence, MIDI workflow, updater, adaptive workspace and versioned native boot.');
