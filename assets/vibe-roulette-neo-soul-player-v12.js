...
export function buildNeoSoulRhodesPlan(chords,options={}){
  ...
  return inheritFirstPassMemory(pocketed,source);
}

export function velocityToGain(velocity,role='inner-voice'){return velocityToGainV11(velocity,role);}

export const NEO_SOUL_PLAYER_V12_INFO={version:'1.2-memory',identity:'Afrobeats harmony first. Soul / Neo-Soul / R&B in the hands. Vocal space always.',changes:['A→A′ phrase memory','returning-chord identity','stable top-line','progression-aware pocket','roots-first left hand','phrase-specific sustain','ornament caps','intentional release','preserved voicing safety']};
