(function () {
  ...
  function mountSoundGym(){
    ...
    css.id = "soundGymHomeFeatureV2";
    css.textContent = `
      .feature-soundgym .media{
        background-image:url('assets/foto-sound-gym.svg?v=sgcover1')!important;
      ...
      .feature-soundgym:after{background:radial-gradient(circle at 14% 82%,rgba(255,92,0,.25),transparent 29%),linear-gradient(180deg,rgba(0,0,0,.04),rgba(0,0,0,.34))!important}
      @media(max-width:760px){
        .feature-soundgym .media{background-position:center center!important}
        .feature-soundgym:before{background:linear-gradient(180deg,rgba(0,0,0,.04),rgba(0,0,0,.10) 38%,rgba(0,0,0,.74) 70%,rgba(0,0,0,.96))!important}
        .feature-soundgym:after{background:radial-gradient(circle at 18% 80%,rgba(255,92,0,.24),transparent 31%),linear-gradient(180deg,rgba(0,0,0,.02),rgba(0,0,0,.24))!important}
      }
    `;
